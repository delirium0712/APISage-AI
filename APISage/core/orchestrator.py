...
class RAGOrchestrator:
    ...
    async def _initialize_agents(self):
        ...
        agents_config = self.system_config.config_data.get("agents", {})
        ...
        # Web Scraper
        if agents_config.get("web_scraper", {}).get("enabled", True):
            await self._initialize_agent("web_scraper", WebScraper)
